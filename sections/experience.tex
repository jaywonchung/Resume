  ...
  \cventryexp
    ...
    {Sep 2021 - Present}
    {
      \begin{cvitems}
        ...
        \item {\href{https://ml.energy/zeus/perseus}{\myuline{\textit{Perseus}}}: A system for energy-efficient large model training. Cuts up to 30\% energy without slowdown. Open-sourced as part of Zeus.}
        \item {\href{https://ml.energy/leaderboard}{\myuline{\textit{ML.ENERGY Leaderboard \& Colosseum}}}: The first systematic benchmark and interactive comparison service for LLM energy consumption.}
      \end{cvitems}
    }
